...
import { FiRefreshCcw, FiSquare, FiTrash2, FiThumbsUp, FiThumbsDown, FiCopy, FiHelpCircle, FiBarChart2, FiVolume2, FiDownload } from "react-icons/fi"; // Import de l'icône de relance, FiSquare et FiTrash2, FiThumbsUp, FiThumbsDown, FiCopy, FiHelpCircle, FiBarChart2, FiVolume2, FiDownload
              ...
              <div className="bg-white rounded-lg p-6 max-w-6xl w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <FiDownload size={20} className="inline" /> Télécharger
                    </button>
                    <button
