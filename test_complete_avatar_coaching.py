...
class AvatarCoachingTester:
    ...
    async def test_quiz_submission(self, quiz_question):
        ...
        try:
            ...
            response = requests.post(
                f"{API_BASE}/api/avatar/quiz/submit",
                data=data
            )
    ...
    async def test_complete_pipeline(self):
        ...
        try:
            ...
            avatar_response = requests.post(
                f"{API_BASE}/api/avatar/generate-real-time-response",
                headers=headers,
                data=avatar_data
            )
    ...
    async def test_streaming_response(self, question):
        ...
        try:
            ...
            response = requests.post(
                f"{API_BASE}/api/avatar/stream-response",
                data=data,
                stream=True
            )
    ...
    async def test_banking_data_questions(self):
        ...
        for question in banking_questions:
            try:
                ...
                response = requests.post(
                    f"{API_BASE}/api/avatar/generate-data-explanation",
                    headers=headers,
                    data=data
                )
